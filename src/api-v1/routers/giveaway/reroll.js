                            ...
                            if (_index == (winners.length - 1)) {
                                ...
                                try {
                                    ...
                                    const finishedEmbed = new Discord.MessageEmbed()
                                        .setColor('#5ccc00').setTitle(giveaway.title+' - Reroll').setDescription(giveaway.description)
                                        .addField('__Prize__', giveaway.prize)
                                        .setURL('https://giveaways-bot.com/g/'+giveaway.id)
                                        .setFooter('GiveAways - Create advanced giveaways!')
